...
function costruisciSala() {
  return _costruisciSala.apply(this, arguments);
}
function _costruisciSala() {
  _costruisciSala = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.n = 1;
          return fetch('sala.json');
        case 1:
          Booking.sala = _context.v;
          _context.n = 2;
          return Booking.sala.json();
        case 2:
          Booking.sala = _context.v;
...
Booking.numeroPersoneW.addEventListener('click', function (e) {
  e.preventDefault();
  var numeroPersone = parseInt(Booking.numeroPersone.textContent);
...
Booking.tavoliW.addEventListener('click', function (e) {
  e.preventDefault();
  var selezionato = parseInt(e.target.textContent);
